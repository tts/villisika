...
I didn't donwload observations on *Sus scrofa scrofa*, [the Southern subspecies](https://en.wikipedia.org/wiki/Central_European_boar) because I'm not sure whether these observations are indeed valid. Are rarity committees a thing also in mammal watching circles?

The number of different variables in this citizen science data are impressive.
...
Yet, seemingly many empty cells. What data should I expect NOT to find? To answer this question, the brand new [naniar package](https://github.com/njtierney/naniar) is of great help. 
...
The most Northern observation comes near Umeå. 
